import{r as p,j as e}from"./vendor-react-DTmZBiFG.js";import{a as R,b as I}from"./api-BR5LSxT6.js";import{u as se}from"./index-BOnGqHK0.js";const X=[{id:"av-indigo",bg:"#EEF2FF",ring:"#4338CA",color:"#4338CA"},{id:"av-violet",bg:"#F5F3FF",ring:"#7C3AED",color:"#7C3AED"},{id:"av-rose",bg:"#FFF1F2",ring:"#BE123C",color:"#BE123C"},{id:"av-amber",bg:"#FFFBEB",ring:"#B45309",color:"#B45309"},{id:"av-green",bg:"#F0FDF4",ring:"#15803D",color:"#15803D"},{id:"av-cyan",bg:"#ECFEFF",ring:"#0E7490",color:"#0E7490"},{id:"av-slate",bg:"#F1F5F9",ring:"#475569",color:"#475569"},{id:"av-fuchsia",bg:"#FDF4FF",ring:"#A21CAF",color:"#A21CAF"}],te=["Asia/Kolkata (IST +5:30)","America/New_York (EST)","Europe/London (GMT)","America/Los_Angeles (PST)"],re=["English (US)","English (UK)","Hindi"],oe=2*1024*1024,Y=`
/* ── Root ── */
.pp-root {
  display: flex;
